		...
		<div class="container">
			<div class="footer-top">
				<div class="footer-nav">
					<img src="<?php echo EYOOM_THEME_URL.'/image/custom/Logo_footer.png' ?>" alt="p2u footer logo">
				</div>
			...
			<div class="footer-cont-info">
				<div class="info">
					<p>
						CS CENTER 1522-2041 <span class="hide-m">|</span> <span class="nl white">평일 10:00 ~ 17:00 (점심 12:00 ~ 13:00)</span>
					</p>
					<span>
						soo@p2u.kr <span class="hide-m">|</span> <span class="nl">토요일, 일요일, 공휴일은 휴무입니다. 근무시간 이후 문의는 1:1 문의를 이용해주세요.</span>
					</span>
				</div>
				<div class="info">
					<p>
					...
					<span>
						사업자 등록번호 : 443-86-024-22 <span class="hide-m">|</span> <span class="nl">통신판매업 : 제2024-서울금천-0326호 | 주소 : 08502 서울 금천구 가산디지털1로 212 202-52호 (가산동, 코오롱디지털타워애스턴)</sapn>
					</span>
				</div>
				<div class="info">
					<span>
